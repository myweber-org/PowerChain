...
module.exports = { validateUserInput, validateEmail, validatePassword };function validateUsername(username) {
...
function validateUserInput(username, password) {
    if (!validateUsername(username)) {
        return { valid: false, message: "Invalid username. Must be 3-20 characters and contain only letters, numbers, and underscores." };
    }
    
    if (!validatePassword(password)) {
        return { valid: false, message: "Invalid password. Must be at least 8 characters with at least one uppercase letter, one lowercase letter, and one number." };
    }
