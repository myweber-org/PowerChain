...
module.exports = { calculateFibonacci, displayFibonacci };function fibonacci(n, memo = {}) {
...
module.exports = { fibonacci, printFibonacciSequence };function calculateFibonacci(n) {
    if (n <= 0) return [];
    if (n === 1) return [0];
...
displayFibonacci();function calculateFibonacci(limit) {
    if (limit <= 0) return [];
    if (limit === 1) return [0];
