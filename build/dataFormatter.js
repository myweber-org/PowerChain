...
export { formatDate, getRelativeTime };function formatDateToISOWithOffset(date) {
    if (!(date instanceof Date) || isNaN(date)) {
        throw new TypeError('Invalid Date object provided');
    }
...
export { formatDateToISOWithOffset };function formatDateWithTimezone(date, includeTime = true) {
    if (!(date instanceof Date)) {
        throw new TypeError('Input must be a Date object');
    }
